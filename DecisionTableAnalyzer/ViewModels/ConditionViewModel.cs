...
{
    [ViewDataType(typeof(ConditionViewData))]
    public class ConditionViewModel : ViewModel<ConditionViewData>
    {
        ...
        public override void CopyFromViewData(ConditionViewData viewData)
        {
            Name = viewData.Name;
            ...
            var conditionNoPreferenceState = CopyViewModelFromViewData<StateViewData, StateViewModel>(viewData.ConditionNoPreferenceState);
            ValidStatesWithEmptyState = ValidStates.ToList();
            ValidStatesWithEmptyState.Add(conditionNoPreferenceState);
        }

        public override void CopyToViewData(ConditionViewData viewData)
        {
        }
