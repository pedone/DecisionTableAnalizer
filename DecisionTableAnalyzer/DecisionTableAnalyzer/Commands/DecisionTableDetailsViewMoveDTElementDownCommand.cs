...
{
    public class DecisionTableDetailsViewMoveDTElementDownCommand : DTCommand<DecisionTableDetailsViewModel>
    {
        ...
        {
            contextViewModel.DecisionTable.MoveElement(contextViewModel.SelectedElement, MoveDestination.Down);
        }
    }
}
