...
{
    public class DecisionTableDetailsViewMoveDTElementTopCommand : DTCommand<DecisionTableDetailsViewModel>
    {
        ...
        {
            contextViewModel.DecisionTable.MoveElement(contextViewModel.SelectedElement, MoveDestination.Top);
        }
    }
}
