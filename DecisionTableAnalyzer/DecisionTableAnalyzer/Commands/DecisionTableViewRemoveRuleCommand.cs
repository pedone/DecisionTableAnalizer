...
{
    public class DecisionTableViewRemoveRuleCommand : DTCommand<DecisionTableViewModel>
    {
        ...
        {
            contextViewModel.DecisionTable.RemoveRule(contextViewModel.SelectedRuleIndex);
        }
